...
const SCHEMA: Record<string, string[]> = {
  ...
  Queue: ["id", "createdAt", "source", "bookingId", "scheduledTime", "checkedInAt", "customer", "phone", "vehicle", "serviceIds", "assignedAttendantIds", "acceptedAttendantIds", "declinedAttendantIds", "preferredAttendantId", "autoAssigned", "status", "priority", "saleId", "paid", "startedAt", "completedAt", "notes"],
